...
export const ASSETS = {
  ...
  signInLogo: "/logo.svg",
  signUpLogo: "/logo.svg",
  article1: "https://lh3.googleusercontent.com/aida-public/AB6AXuAfc6kyyhK017Ld0aDOrWJoz9nDZqvbjv8xz_2lM3qb-IkquCf7q82GtcSI20DFjX57kqY3Wh82H3JiXRay8qMFR2NCYKtl0luazbG46JG5ep-IeCb2NkJ36jXLZzCyRK4NdM0orVE9Sb9u4Hl1GwXG5lXysw_G0aoRhsa4MyAg-9HC4BJMMcjLlovvFxuxzODyODU4ha5v6BVobB1HyIC-HmqEWvka8qU1lg5GJny9NO9GGACV4udKag",
  article2: "https://lh3.googleusercontent.com/aida-public/AB6AXuB1zI7U5XVVjKmlw-KMvOhKPMqIGl2BCMoSw4yOuZK070HCQAJMNMeBGjrXtSJ0fGoMjKXBK4XHDAp2hiqbB8e8yWtudCQIf6As-A0P-zwUM-iaZzBIaMM3nv5sbahxPBeZoYVcLtRUk71yV_7JWo8o9iO5ceXSCiGjjWWNtkLeZbgBqUNyPMTxIw0FCImKzSbVesXEYskaW-dcuQZnRWGyiSYibBD1AvDDAqK3Jvr_WsvveBzOgbTu5A",
  drSharma: "https://lh3.googleusercontent.com/aida-public/AB6AXuCOh22XaRlTCnytj7Y9Ya8gx2jL3fZs8uC3Y32ZL0yl-YSIbZUdbONgHd14kg8lJzbfzL_10U8RCVdGs2Uis0eY4ayZf6Klfn5GA85y3064DAlE5-912K6ygQblhZYnmIUFGaXyb9fuC00yOo36t13N4Hzv_yotF-mFak-iGuTTUWmMusSUTc5pusOAJ2oVWCymfLBo05l5A-wOywYKqTIeRWrZHk5gSyGzuCF-_Fku-HRruoTYnusIIg",
  drVance: "https://lh3.googleusercontent.com/aida-public/AB6AXuAkqhRRKhZtMqTZvZFCeI-6IRdEw0qSabbiWo1eLlzroPC_JGWw9gRFCRas863IAxhMPvS3nbQ5pq0HsYk9AYUzTJmIMA03erUYYtzd3P5tC4kkGQGcYqgh2X0LLd0UN5TPY8BlLpW68oTKX6BI7sk9c5Fksgo8fWB6kSr8EqqLKwY_QWpFvd_WVYtDnGkJviPfJTR_NeP39Yffw5b4cmRU63vGFmRoptAUvCdbP2owq65U_56AVf_fig",
  rohanPartner: "https://lh3.googleusercontent.com/aida-public/AB6AXuDAwWZ6gylebt-v0AFGCuzoHUHpi3zlgEHhKflSpA9sZ9o5EOp5EdEkxw1uEmuZTVIuQqWGK5qaeqn4nJHs0NGB7ACroO0dmJK8nawXsf1Co8MsFltYF_LIlptkMNMfnjndN6IhwdUbVEXyboMLsY-T1zNFrbDF6S0d6frNuVnir9GwuTW6vMbwa6jWQRndDpMJh7TNVqjAiqAIULlD7sP-Y2CO1iHf0EzqkHhLDeR8X3-FkNHNE2JBKQ"
};

export const INITIAL_CARE_TEAM: CareMember[] = [
  {
    id: "dr-sharma",
...
export const AUDIO_TRACKS: AudioTrack[] = [
  {
    ...
    description: "Gentle restorative diaphragmatic breathing tailored to decompress the pelvic sling.",
  ...
  },
  {
    ...
    description: "Soothing delta-wave pacing designed to calm hyper-vigilance during late pregnancy and newborn nights.",
  ...
  },
  {
    ...
    description: "Traditional golden month broths, sesame seeds, and warm digestive nourishment guidance.",
  ...
  },
  {
    ...
    description: "Step-by-step biomechanics for log-rolling out of bed and carrying your infant without intra-abdominal pressure.",
...
export const ARTICLES: ArticleItem[] = [
  {
    ...
    snippet: "What to expect as you enter the final stretch of your beautiful journey.",
  ...
  },
  {
    ...
    snippet: "Discover how your little one is reacting to light, sound, and your voice every day.",
